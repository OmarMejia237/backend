            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="card "  style="background-color:#a2ded0; border:solid #000;">
                        ...
                        <div class="card-body">
                            <form action="<?php echo RUTA_URL;?>/usuarios/borrar/<?php echo $datos['email']?>" method="POST">
                                <div class="row">
                                         <div class="col-sm-4">
      ...
      <!-- Button -->               <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <button id="Registrarse" type="submit" name="Registrarse" class="btn btn-dark">Borrar</button>
                                            </div>
                                        </div>
                                    </div>
                            </form>
