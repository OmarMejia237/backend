                ...
                <div class="col-sm-8">
                    <div class="card bg-warning">
                        <div class="card-header">
                            Confirmacion de actualizar Publicacion <i class="fa fa-user-minus text-danger float:right"></i>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo RUTA_URL;?>/publicars/editar1/<?php echo $datos['id'] ?>" method="post" enctype="multipart/form-data">
